(function(k,q,d){function w(c){h?c():y.push(c)}function E(c){var a,b;if(q.getSelection){if(a=q.getSelection(),a.getRangeAt&&a.rangeCount){b=a.getRangeAt(0);b.deleteContents();var e=k.createElement("div");e.innerHTML=c;c=k.createDocumentFragment();for(var d,f;d=e.firstChild;)f=c.appendChild(d);b.insertNode(c);f&&(b=b.cloneRange(),b.setStartAfter(f),b.collapse(!0),a.removeAllRanges(),a.addRange(b))}}else k.selection&&"Control"!=k.selection.type&&k.selection.createRange().pasteHTML(c)}function F(c,a,
b){var e=!0,p=1;if(a){a=a.toLowerCase();b=b||[];do{var f=1==p?"@"+a:a;l[c.id][f]&&l[c.id][f].length&&d.each(l[c.id][f],function(a,f){return e=!1!==f.apply(c,b)})}while(e&&p--)}return e}function R(c,a){return d(a.currentTarget)}function r(c,a,b,e){function p(a,b,f){a.on(b,function(){var a=d.isFunction(e)?e.apply(c,[b].concat(K.call(arguments))):e;a&&F(c,f,[a].concat(K.call(arguments)))})}function f(a){"string"===(typeof b).toLowerCase()?p(a,b,b):d.each(b,function(c,e){p(a,d.isArray(b)?e:c,e)})}e=e||
R;d.isArray(a)?d.each(a,function(a,b){f(d(b))}):f(a)}function L(c,a){c=c.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/(?:\r\n|\r|\n)/g,"\n").replace(/(\n+)/g,"<div>$1</div>").replace(/\n/g,"<br/>").replace(/<br\/><\/div>/g,"</div>");a.shortnames&&(c=h.shortnameToUnicode(c));return S(c,'<img alt="{alt}" class="emojione'+(a.sprite?'-{uni}" src="'+M+'">':'" src="{img}">')).replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/  /g,"&nbsp;&nbsp;")}function H(c,a){c=c.replace(/<img[^>]*alt="([^"]+)"[^>]*>/ig,
...
"\n\n").replace(/<(?:[^>]+)?>/g,"").replace(/&nbsp;/g," ").replace(/\x20\x20/g,"&nbsp; ").replace(/\x20\x20/g," &nbsp;");return a&&a.shortnames?h.toShort(c):c}function N(c,a,b){return c.replace("{name}",b||"").replace("{img}",h.imagePathPNG+a+".png").replace("{uni}",a).replace("{alt}",h.convert(a))}function S(c,a){return c.replace(O,function(b){return"undefined"!==typeof b&&b in h.jsecapeMap?N(a,h.jsecapeMap[b]):b})}function I(c,a){return c.replace(/:?[\w_]+:?/g,function(b){b=":"+b.replace(/:$/,"").replace(/^:/,
"")+":";return b in u?N(a,u[b][u[b].length-1].toUpperCase(),b):b})}function T(c,a){function b(){x||(d.each(z,function(a,b){x+=d(b).outerWidth(!0)}),u=z.eq(0).outerWidth(!0));x>A?(B.addClass("active"),C.addClass("active"),n+x<=A?(n=A-x,B.removeClass("active")):0<=n&&(n=0,C.removeClass("active")),t.css("left",n)):(0!==n&&(n=0,t.css("left",n)),B.removeClass("active"),C.removeClass("active"))}a=d.extend({},U,a);var e=this,p=c.is("TEXTAREA")||c.is("INPUT")?"val":"text",f=a.template,k=!1,h=a.container?
d(a.container):!1,g,m,v,t,z,C,B,A,n=0,x=0,u,w=function(){var a=m.width();a!==A&&(A=a,F(e,"resize",[g]))},y;e.id=(new Date).getTime();e.sprite=a.useSprite;e.shortnames=a.shortnames;l[e.id]={};for(var D=["editor","filters","tabs"],s=0;3>s;s++)f=f.replace(RegExp("<"+D[s]+"/?>","i"),'<div class="emojionearea-'+D[s]+'"></div>');f=d("<div/>",{"class":c.attr("class"),role:"application"}).addClass("emojionearea").html(f);g=e.editor=f.find(".emojionearea-editor").attr({contenteditable:!0,placeholder:a.placeholder||
c.data("placeholder")||c.attr("placeholder")||"",tabindex:0});D=["dir","spellcheck","autocomplete","autocorrect","autocapitalize"];for(s=0;5>s;s++)g.attr(D[s],a[D[s]]);m=f.find(".emojionearea-filters");a.autoHideFilters&&m.hide();v=f.find(".emojionearea-tabs");d.each(a.filters,function(a,b){d("<i/>",{"class":"emojionearea-filter","data-filter":a}).wrapInner(I(b.icon,e.sprite?'<i class="emojione-{uni}"/>':'<img class="emojione" src="{img}"/>')).appendTo(m);d("<div/>",{"class":"emojionearea-tab emojionearea-tab-"+
a}).hide().data("items",I(b.emoji,'<i class="emojibtn" role="button">'+(e.sprite?'<i class="emojione-{uni}"':'<img class="emojione" src="{img}"')+' data-name="{name}"/></i>')).appendTo(v)});m.wrapInner('<div class="emojionearea-filters-scroll"/>');C=d('<i class="emojionearea-filter-arrow-left"/>',{role:"button"}).appendTo(m);B=d('<i class="emojionearea-filter-arrow-right"/>',{role:"button"}).appendTo(m);z=m.find(".emojionearea-filter");t=m.children(".emojionearea-filters-scroll");h?h.wrapInner(f):
f.insertAfter(c);a.hideSource&&c.hide();e.setText(c[p]());r(e,[m,v],{mousedown:"area.mousedown"},g);r(e,g,"paste",g);r(e,g,["focus","blur"],function(){return k?!1:g});r(e,[g,m,v],["mousedown","mouseup","click","keyup","keydown"],g);r(e,m.find(".emojionearea-filter"),{click:"filter.click"});r(e,C,{click:"arrowLeft.click"});r(e,B,{click:"arrowRight.click"});e.on("@filter.click",function(a){if(a.is(".active"))a.removeClass("active"),v.children().hide();else{z.filter(".active").removeClass("active");
a.addClass("active");var b,c,f=v.children().hide().filter(".emojionearea-tab-"+a.data("filter")).show(),d=f.data("items"),g={click:"emojibtn.click"};d&&(f.data("items",!1),d=d.split(","),e.sprite?(f.html(d.join("")),r(e,f.find(".emojibtn"),g)):c=P(function(){for(b=0;20>b&&d.length;b++)f.append(d.shift()),r(e,f.find(".emojibtn").not(".handled").addClass("handled"),g);d.length||Q(c)},5))}}).on("@resize",function(){b()}).on("@arrowLeft.click",function(){n+=u;b()}).on("@arrowRight.click",function(){n-=
u;b()}).on("@paste",function(a){k=!0;E("<span> </span>");var b=G(a[0]),c=a.scrollTop(),f=d("<div/>").appendTo(d("BODY")).attr("contenteditable","true").css({position:"fixed",left:"-999px",width:"1px",height:"1px",top:"20px",overflow:"hidden"}).focus();q.setTimeout(function(){var g="caret-"+(new Date).getTime();a.focus();J(a[0],b);E(L(H(f.html().replace(/\r\n|\n|\r/g,"<br>"),e),e));f.remove();E('<i id="'+g+'"></i>');a.scrollTop(c);var g=d("#"+g),p=g.offset().top-a.offset().top,h=a.height();(c+p>=h||
c>p)&&a.scrollTop(c+p-2*h/3);g.remove();k=!1},200)}).on("@emojibtn.click",function(a){G(g[0]);E(I(a.children().data("name"),'<img alt="{alt}" class="emojione'+(e.sprite?'-{uni}" src="'+M+'">':'" src="{img}">')))}).on("@area.mousedown",function(b,c){!a.autoHideFilters&&!f.is(".focused")&&b.focus();c.preventDefault();return!1}).on("@change",function(a){a=a.html().replace(/<\/?(?:div|span|p)[^>]*>/ig,"");(!a.length||/^<br[^>]*>$/i.test(a))&&e.setText("",!1);c[p](e.getText())}).on("@focus",function(){w();
y=P(w,500);f.addClass("focused");a.autoHideFilters&&m.slideDown(400)}).on("@blur",function(d){n=0;b();f.removeClass("focused");Q(y);a.autoHideFilters&&m.slideUp(400);z.filter(".active").removeClass("active");v.children().hide();d=d.html();e.content!==d?(e.content=d,F(e,"change",[g]),c.blur().trigger("change")):c.blur()})}var M="data:image/gif;base64,R0lGODlhAQABAJH/AP///wAAAMDAwAAAACH5BAEAAAIALAAAAAABAAEAAAICVAEAOw==",U={template:"<editor/><filters/><tabs/>",dir:"ltr",spellcheck:!1,autocomplete:"off",
autocorrect:"off",autocapitalize:"off",placeholder:null,container:null,hideSource:!0,autoHideFilters:!1,shortnames:!1,useSprite:!0,filters:{people:{icon:"yum",emoji:"grinning,grin,joy,smiley,smile,sweat_smile,laughing,innocent,smiling_imp,imp,wink,blush,relaxed,yum,relieved,heart_eyes,sunglasses,smirk,neutral_face,expressionless,unamused,sweat,pensive,confused,confounded,kissing,kissing_heart,kissing_smiling_eyes,kissing_closed_eyes,stuck_out_tongue,stuck_out_tongue_winking_eye,stuck_out_tongue_closed_eyes,disappointed,worried,angry,rage,cry,persevere,triumph,disappointed_relieved,frowning,anguished,fearful,weary,sleepy,tired_face,grimacing,sob,open_mouth,hushed,cold_sweat,scream,astonished,flushed,sleeping,dizzy_face,no_mouth,mask,slight_frown,slight_smile,smile_cat,joy_cat,smiley_cat,heart_eyes_cat,smirk_cat,kissing_cat,pouting_cat,crying_cat_face,scream_cat,footprints,bust_in_silhouette,busts_in_silhouette,levitate,spy,baby,boy,girl,man,woman,family,family_mwg,family_mwgb,family_mwbb,family_mwgg,family_wwb,family_wwg,family_wwgb,family_wwbb,family_wwgg,family_mmb,family_mmg,family_mmgb,family_mmbb,family_mmgg,couple,two_men_holding_hands,two_women_holding_hands,dancers,bride_with_veil,person_with_blond_hair,man_with_gua_pi_mao,man_with_turban,older_man,older_woman,cop,construction_worker,princess,guardsman,angel,santa,ghost,japanese_ogre,japanese_goblin,poop,skull,alien,space_invader,bow,information_desk_person,no_good,ok_woman,raising_hand,person_with_pouting_face,person_frowning,massage,haircut,couple_with_heart,couple_ww,couple_mm,couplekiss,kiss_ww,kiss_mm,raised_hands,clap,ear,eye,eyes,nose,lips,kiss,tongue,nail_care,wave,thumbsup,thumbsdown,point_up,point_up_2,point_down,point_left,point_right,ok_hand,v,punch,fist,raised_hand,muscle,open_hands,writing_hand,hand_splayed,middle_finger,vulcan,pray"},
...
K=[].slice,h=q.emojione||!1,G,J,u={},l={},P=q.setInterval,Q=q.clearInterval,y=[],O;h||d.getScript("https://cdn.jsdelivr.net/emojione/1.5.0/lib/js/emojione.min.js",function(){h=q.emojione;h.imagePathPNG="https://cdnjs.cloudflare.com/ajax/libs/emojione/1.5.0/assets/png/";k.createStyleSheet?k.createStyleSheet("https://cdnjs.cloudflare.com/ajax/libs/emojione/1.5.0/assets/sprites/emojione.sprites.css"):d("<link/>",{rel:"stylesheet",href:"https://cdnjs.cloudflare.com/ajax/libs/emojione/1.5.0/assets/sprites/emojione.sprites.css"}).appendTo("head");
d.each(y,function(c,a){a()})});w(function(){d.each(h.emojioneList,function(c,a){u[c.replace("-","_")]=a});O=RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|("+h.unicodeRegexp+")","gi")});q.getSelection&&k.createRange?(G=function(c){var a=q.getSelection().getRangeAt(0),b=a.cloneRange();b.selectNodeContents(c);b.setEnd(a.startContainer,a.startOffset);c=b.toString().length;return{start:c,end:c+H(d("<div/>").append(a.extractContents()).html()).length}},
J=function(c,a){var b=0,e=k.createRange();e.setStart(c,0);e.collapse(!0);for(var d=[c],f,h=!1,l=!1;!l&&(f=d.pop());)if(3==f.nodeType){var g=b+f.length;!h&&(a.start>=b&&a.start<=g)&&(e.setStart(f,a.start-b),h=!0);h&&(a.end>=b&&a.end<=g)&&(e.setEnd(f,a.end-b),l=!0);b=g}else for(g=f.childNodes.length;g--;)d.push(f.childNodes[g]);b=q.getSelection();b.removeAllRanges();b.addRange(e)}):k.selection&&k.body.createTextRange&&(G=function(c){var a=k.selection.createRange(),b=k.body.createTextRange();b.moveToElementText(c);
b.setEndPoint("EndToStart",a);c=b.text.length;return{start:c,end:c+a.text.length}},J=function(c,a){var b=k.body.createTextRange();b.moveToElementText(c);b.collapse(!0);b.moveEnd("character",a.end);b.moveStart("character",a.start);b.select()});var t=function(c,a){var b=this;w(function(){T.apply(b,[c,a])})};t.prototype.on=function(c,a){var b=this.id;c&&d.isFunction(a)&&d.each(c.toLowerCase().split(" "),function(c,d){l[b][d]||(l[b][d]=[]);l[b][d].push(a)});return this};t.prototype.off=function(c,a){var b=
this.id,e=/^@/;c&&d.each(c.toLowerCase().split(" "),function(c,f){l[b][f]&&!e.test(f)&&(a?d.each(l[b][f],function(c,d){d===a&&(l[b][f]=l[b][f].splice(c,1))}):l[b][f]=[])});return this};t.prototype.setText=function(c){var a=this,b=arguments;w(function(){a.editor.html(L(c,a));a.content=a.editor.html();1===b.length&&F(a,"change",[a.editor])})};t.prototype.getText=function(){return H(this.editor.html(),this)};d.fn.emojioneArea=function(c){return this.each(function(){return this.emojioneArea?this.emojioneArea:
this.emojioneArea=new t(d(this),c)})}})(document,window,jQuery);
