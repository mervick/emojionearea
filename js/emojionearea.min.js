(function(h,r,d,l){function t(c){var b,a;if(r.getSelection){if(b=r.getSelection(),b.getRangeAt&&b.rangeCount){a=b.getRangeAt(0);a.deleteContents();var f=h.createElement("div");f.innerHTML=c;c=h.createDocumentFragment();for(var d,e;d=f.firstChild;)e=c.appendChild(d);a.insertNode(c);e&&(a=a.cloneRange(),a.setStartAfter(e),a.collapse(!0),b.removeAllRanges(),b.addRange(a))}}else h.selection&&"Control"!=h.selection.type&&h.selection.createRange().pasteHTML(c)}function w(c){var b=this,a=!0,f;c&&(f=x.call(arguments,
1),d.each(c.toLowerCase().split(" "),function(c,e){for(var y=0;1>=y;y++){var g=0==y?"@"+e:e;k[b.id][g]&&k[b.id][g].length&&d.each(k[b.id][g],function(c,e){return a=!1!==e.apply(b,f)});if(!a)break}return a}));return a}function E(c,b){return d(b.currentTarget)}function q(c,b,a,f){function m(a,b,e){a.on(b,function(){var a=d.isFunction(f)?f.apply(c,[b].concat(x.call(arguments))):f;a&&w.apply(c,[e].concat([a]).concat(x.call(arguments)))})}function e(b){"string"===(typeof a).toLowerCase()?m(b,a,a):d.each(a,
function(c,f){m(b,d.isArray(a)?f:c,f)})}f=f||E;d.isArray(b)?d.each(b,function(a,b){e(d(b))}):e(b)}function D(c){return F(c.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/(?:\r\n|\r|\n)/g,"\n").replace(/(\n+)/g,"<div>$1</div>").replace(/\n/g,"<br/>").replace(/<br\/><\/div>/g,"</div>")).replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/  /g,"&nbsp;&nbsp;")}function z(c){return c.replace(/<img[^>]*alt="([^"]+)"[^>]*>/ig,"$1").replace(/\n|\r/g,"").replace(/<br[^>]*>/ig,"\n").replace(/(?:<(?:div|p|ol|ul|li|pre|code|object)[^>]*>)+/ig,
...
" &nbsp;")}function F(c){return c.replace(RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|("+l.unicodeRegexp+")","gi"),function(b){if("undefined"===typeof b||""===b||!(b in l.jsecapeMap))return b;b=l.jsecapeMap[b];return'<img class="emojione" alt="'+l.convert(b)+'" src="'+l.imagePathPNG+b+".png"+l.cacheBustParam+'"/>'})}function A(c,b){return c.replace(/:?[\w_]+:?,?/g,function(a){a=":"+a.replace(/,$/,"").replace(/:$/,"").replace(/^:/,"")+":";if(a in
u){var c=u[a][u[a].length-1].toUpperCase(),d=l.convert(c);return b.replace("{shortname}",a).replace("{imagePng}",l.imagePathPNG+c+".png"+l.cacheBustParam).replace("{unicode}",c).replace("{alt}",d)}return a})}function G(c,b){b=d.extend({},H,b);var a=this,f,m,e,h=c.is("TEXTAREA")?"val":"text",g=b.template,l=!1,p=b.container?d(b.container):!1;a.placeholder=b.placeholder||c.data("placeholder")||c.attr("placeholder")||"";k[a.id]={};for(var s=["editor","filters","tabs"],n=0;3>n;n++)g=g.replace(RegExp("<"+
s[n]+"/?>","i"),'<div class="emojionearea-'+s[n]+'"></div>');g=d("<div>"+g+"</div>").addClass("emojionearea").attr("role","application");this.editor=g.find(".emojionearea-editor").attr("contenteditable","true").attr("placeholder",a.placeholder).attr("tabindex",0);f=a.editor;s=["dir","spellcheck","autocomplete","autocorrect","autocapitalize"];for(n=0;5>n;n++)f.attr(s[n],b[s[n]]);m=g.find(".emojionearea-filters");b.autoHideFilters&&m.hide();e=g.find(".emojionearea-tabs");d.each(b.filters,function(a,
b){d("<span/>").wrapInner(A(b.icon,'<span class="emojione-{unicode}">{alt}</span>')).addClass("emojionearea-filter").attr("data-filter",a).attr("role","button").appendTo(m);d("<div/>").wrapInner(A(b.emoji,'<span class="emojibtn"><span class="emojione-{unicode}" data-shortname="{shortname}">{alt}</span></span>')).addClass("emojionearea-tab").addClass("emojionearea-tab-"+a).hide().appendTo(e)});p?p.replaceWith(g):g.insertAfter(c);b.hideSource&&c.hide();a.setText(c[h]());q(a,[m,e],{mousedown:"area.mousedown"},
f);q(a,f,"paste",f);q(a,f,{focus:"editor.focus",blur:"editor.blur"},f);q(a,f,["focus","blur"],function(){return l?!1:f});q(a,[f,m,e],["mousedown","mouseup","click","keyup","keydown"],f);q(a,m.find(".emojionearea-filter"),{click:"filter.click"});q(a,e.find(".emojibtn"),{click:"emojibtn.click"});a.on("@filter.click",function(a){a.is(".active")?(a.removeClass("active"),e.children().hide()):(a.parent().find(".active").removeClass("active"),a.addClass("active"),e.children().hide().filter(".emojionearea-tab-"+
a.data("filter")).show())}).on("@paste",function(a){l=!0;t("<span>&nbsp;</span>");var b=v(a[0]),c=B.scrollTop(),e=a.scrollTop(),f=d("<div/>").appendTo(d("BODY")).attr("contenteditable","true").attr("tabindex","0").css({position:"fixed",left:"-9999px",width:"1px",height:"1px",top:10}).focus();B.scrollTop(c);a.removeAttr("contenteditable");r.setTimeout(function(){var m="caret-"+(new Date).getTime();a.attr("contenteditable","true").focus();C(a[0],b);t(D(z(f.html().replace(/\r\n|\n|\r/g,"<br>"))));f.remove();
t('<span id="'+m+'"></span>');B.scrollTop(c);a.scrollTop(e);var m=d("#"+m),g=m.offset().top-a.offset().top,h=a.height();(e+g>=h||e>g)&&a.scrollTop(e+g-2*h/3);m.remove();l=!1},200)}).on("@emojibtn.click",function(a){v(f[0]);t(A(a.children("span").data("shortname"),'<img class="emojione" alt="{alt}" src="{imagePng}"/>'))}).on("@area.mousedown",function(a,c){!b.autoHideFilters&&!g.is(".focused")&&a.focus();c.preventDefault();return!1}).on("@change",function(){var a=f.html();/^<br[^>]*>$/.test(a.replace(/<\/?div[^>]*>/g,
""))&&this.setText("");c[h](this.getText())}).on("@focus",function(){g.addClass("focused");b.autoHideFilters&&m.slideDown(400)}).on("@blur",function(c){g.removeClass("focused");b.autoHideFilters&&m.slideUp(400);m.find(".active").removeClass("active");e.children().hide();c=c.html();a.content!==c&&(a.content=c,w.apply(a,["change",a.content]))})}var H={template:"<editor/><filters/><tabs/>",className:"emojionearea",editorClassName:"emojionearea-editor",filtersClassName:"emojionearea-filters",filterClassName:"emojionearea-filter",
tabsClassName:"emojionearea-tabs",tabClassName:"emojionearea-tab",dir:"ltr",spellcheck:!0,autocomplete:"off",autocorrect:"off",autocapitalize:"off",placeholder:null,container:null,hideSource:!0,autoHideFilters:!1,filters:{people:{icon:"yum",emoji:"grinning,grin,joy,smiley,smile,sweat_smile,laughing,innocent,smiling_imp,imp,wink,blush,relaxed,yum,relieved,heart_eyes,sunglasses,smirk,neutral_face,expressionless,unamused,sweat,pensive,confused,confounded,kissing,kissing_heart,kissing_smiling_eyes,kissing_closed_eyes,stuck_out_tongue,stuck_out_tongue_winking_eye,stuck_out_tongue_closed_eyes,disappointed,worried,angry,rage,cry,persevere,triumph,disappointed_relieved,frowning,anguished,fearful,weary,sleepy,tired_face,grimacing,sob,open_mouth,hushed,cold_sweat,scream,astonished,flushed,sleeping,dizzy_face,no_mouth,mask,slight_frown,slight_smile,smile_cat,joy_cat,smiley_cat,heart_eyes_cat,smirk_cat,kissing_cat,pouting_cat,crying_cat_face,scream_cat,footprints,bust_in_silhouette,busts_in_silhouette,levitate,spy,baby,boy,girl,man,woman,family,family_mwg,family_mwgb,family_mwbb,family_mwgg,family_wwb,family_wwg,family_wwgb,family_wwbb,family_wwgg,family_mmb,family_mmg,family_mmgb,family_mmbb,family_mmgg,couple,two_men_holding_hands,two_women_holding_hands,dancers,bride_with_veil,person_with_blond_hair,man_with_gua_pi_mao,man_with_turban,older_man,older_woman,cop,construction_worker,princess,guardsman,angel,santa,ghost,japanese_ogre,japanese_goblin,poop,skull,alien,space_invader,bow,information_desk_person,no_good,ok_woman,raising_hand,person_with_pouting_face,person_frowning,massage,haircut,couple_with_heart,couple_ww,couple_mm,couplekiss,kiss_ww,kiss_mm,raised_hands,clap,ear,eye,eyes,nose,lips,kiss,tongue,nail_care,wave,thumbsup,thumbsdown,point_up,point_up_2,point_down,point_left,point_right,ok_hand,v,punch,fist,raised_hand,muscle,open_hands,writing_hand,hand_splayed,middle_finger,vulcan,pray"},
...
x=[].slice,v,C,u={},B=d(h),k={};d.each(l.emojioneList,function(c,b){u[c.replace("-","_")]=b});r.getSelection&&h.createRange?(v=function(c){var b=r.getSelection().getRangeAt(0),a=b.cloneRange();a.selectNodeContents(c);a.setEnd(b.startContainer,b.startOffset);c=a.toString().length;return{start:c,end:c+z(d("<div/>").append(b.extractContents()).html()).length}},C=function(c,b){var a=0,f=h.createRange();f.setStart(c,0);f.collapse(!0);for(var d=[c],e,l=!1,g=!1;!g&&(e=d.pop());)if(3==e.nodeType){var k=a+
e.length;!l&&(b.start>=a&&b.start<=k)&&(f.setStart(e,b.start-a),l=!0);l&&(b.end>=a&&b.end<=k)&&(f.setEnd(e,b.end-a),g=!0);a=k}else for(k=e.childNodes.length;k--;)d.push(e.childNodes[k]);a=r.getSelection();a.removeAllRanges();a.addRange(f)}):h.selection&&h.body.createTextRange&&(v=function(c){var b=h.selection.createRange(),a=h.body.createTextRange();a.moveToElementText(c);a.setEndPoint("EndToStart",b);c=a.text.length;return{start:c,end:c+b.text.length}},C=function(c,b){var a=h.body.createTextRange();
a.moveToElementText(c);a.collapse(!0);a.moveEnd("character",b.end);a.moveStart("character",b.start);a.select()});var p=function(c,b){this.id=(new Date).getTime();G.apply(this,[d(c),b])};p.prototype.on=function(c,b){var a=this;c&&d.isFunction(b)&&d.each(c.toLowerCase().split(" "),function(c,d){k[a.id][d]||(k[a.id][d]=[]);k[a.id][d].push(b)});return a};p.prototype.off=function(c,b){var a=this,f=/^@/;c&&(d.isFunction(b)?d.each(c.toLowerCase().split(" "),function(c,e){k[a.id][e]&&!f.test(e)&&d.each(k[a.id][e],
function(c,d){d===b&&(k[a.id][e]=k[a.id][e].splice(c,1))})}):d.each(c.split(" "),function(b,c){f.test(c)||(k[a.id][c]=[])}));return a};p.prototype.setText=function(c){this.editor.html('<div class="placeholder-fix">'+D(c)+"</div>");this.placeholder&&this.editor.children(".placeholder-fix:first").attr("placeholder",this.placeholder);this.content=this.editor.html();w.apply(this,["change",this.content])};p.prototype.getText=function(){return z(this.editor.html())};d.fn.emojioneArea=function(c){return this.each(function(){return this.emojioneArea?
this.emojioneArea:this.emojioneArea=new p(d(this),c)})}})(document,window,jQuery,emojione);
