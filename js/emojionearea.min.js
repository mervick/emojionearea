(function(h,q,d){function w(c){k?c():y.push(c)}function E(c){var a,b;if(q.getSelection){if(a=q.getSelection(),a.getRangeAt&&a.rangeCount){b=a.getRangeAt(0);b.deleteContents();var f=h.createElement("div");f.innerHTML=c;c=h.createDocumentFragment();for(var d,e;d=f.firstChild;)e=c.appendChild(d);b.insertNode(c);e&&(b=b.cloneRange(),b.setStartAfter(e),b.collapse(!0),a.removeAllRanges(),a.addRange(b))}}else h.selection&&"Control"!=h.selection.type&&h.selection.createRange().pasteHTML(c)}function F(c,a,
b){var f=!0,p=1;if(a){a=a.toLowerCase();b=b||[];do{var e=1==p?"@"+a:a;m[c.id][e]&&m[c.id][e].length&&d.each(m[c.id][e],function(a,e){return f=!1!==e.apply(c,b)})}while(f&&p--)}return f}function R(c,a){return d(a.currentTarget)}function r(c,a,b,f){function p(a,b,e){a.on(b,function(){var a=d.isFunction(f)?f.apply(c,[b].concat(K.call(arguments))):f;a&&F(c,e,[a].concat(K.call(arguments)))})}function e(a){"string"===(typeof b).toLowerCase()?p(a,b,b):d.each(b,function(c,f){p(a,d.isArray(b)?f:c,f)})}f=f||
R;d.isArray(a)?d.each(a,function(a,b){e(d(b))}):e(a)}function L(c,a){return S(c.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/(?:\r\n|\r|\n)/g,"\n").replace(/(\n+)/g,"<div>$1</div>").replace(/\n/g,"<br/>").replace(/<br\/><\/div>/g,"</div>"),'<img alt="{alt}" class="emojione'+(a.sprite?'-{uni}" src="'+M+'">':'" src="{img}">')).replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/  /g,"&nbsp;&nbsp;")}function H(c){return c.replace(/<img[^>]*alt="([^"]+)"[^>]*>/ig,"$1").replace(/\n|\r/g,"").replace(/<br[^>]*>/ig,
...
a){function b(){x||(d.each(z,function(a,b){x+=d(b).outerWidth(!0)}),u=z.eq(0).outerWidth(!0));x>A?(B.addClass("active"),C.addClass("active"),n+x<=A?(n=A-x,B.removeClass("active")):0<=n&&(n=0,C.removeClass("active")),t.css("left",n)):(0!==n&&(n=0,t.css("left",n)),B.removeClass("active"),C.removeClass("active"))}a=d.extend({},U,a);var f=this,p=c.is("TEXTAREA")||c.is("INPUT")?"val":"text",e=a.template,h=!1,k=a.container?d(a.container):!1,g,l,v,t,z,C,B,A,n=0,x=0,u,w=function(){var a=l.width();a!==A&&
(A=a,F(f,"resize",[g]))},y;f.id=(new Date).getTime();f.sprite=a.useSprite;m[f.id]={};for(var D=["editor","filters","tabs"],s=0;3>s;s++)e=e.replace(RegExp("<"+D[s]+"/?>","i"),'<div class="emojionearea-'+D[s]+'"></div>');e=d("<div/>",{"class":c.attr("class"),role:"application"}).addClass("emojionearea").html(e);g=f.editor=e.find(".emojionearea-editor").attr({contenteditable:!0,placeholder:a.placeholder||c.data("placeholder")||c.attr("placeholder")||"",tabindex:0});D=["dir","spellcheck","autocomplete",
"autocorrect","autocapitalize"];for(s=0;5>s;s++)g.attr(D[s],a[D[s]]);l=e.find(".emojionearea-filters");a.autoHideFilters&&l.hide();v=e.find(".emojionearea-tabs");d.each(a.filters,function(a,b){d("<i/>",{"class":"emojionearea-filter","data-filter":a}).wrapInner(I(b.icon,f.sprite?'<i class="emojione-{uni}"/>':'<img class="emojione" src="{img}"/>')).appendTo(l);d("<div/>",{"class":"emojionearea-tab emojionearea-tab-"+a}).hide().data("items",I(b.emoji,'<i class="emojibtn" role="button">'+(f.sprite?'<i class="emojione-{uni}"':
'<img class="emojione" src="{img}"')+' data-name="{name}"/></i>')).appendTo(v)});l.wrapInner('<div class="emojionearea-filters-scroll"/>');C=d('<i class="emojionearea-filter-arrow-left"/>',{role:"button"}).appendTo(l);B=d('<i class="emojionearea-filter-arrow-right"/>',{role:"button"}).appendTo(l);z=l.find(".emojionearea-filter");t=l.children(".emojionearea-filters-scroll");k?k.wrapInner(e):e.insertAfter(c);a.hideSource&&c.hide();f.setText(c[p]());r(f,[l,v],{mousedown:"area.mousedown"},g);r(f,g,"paste",
g);r(f,g,["focus","blur"],function(){return h?!1:g});r(f,[g,l,v],["mousedown","mouseup","click","keyup","keydown"],g);r(f,l.find(".emojionearea-filter"),{click:"filter.click"});r(f,C,{click:"arrowLeft.click"});r(f,B,{click:"arrowRight.click"});f.on("@filter.click",function(a){if(a.is(".active"))a.removeClass("active"),v.children().hide();else{z.filter(".active").removeClass("active");a.addClass("active");var b,c,e=v.children().hide().filter(".emojionearea-tab-"+a.data("filter")).show(),d=e.data("items"),
g={click:"emojibtn.click"};d&&(e.data("items",!1),d=d.split(","),f.sprite?(e.html(d.join("")),r(f,e.find(".emojibtn"),g)):c=P(function(){for(b=0;20>b&&d.length;b++)e.append(d.shift()),r(f,e.find(".emojibtn").not(".handled").addClass("handled"),g);d.length||Q(c)},5))}}).on("@resize",function(){b()}).on("@arrowLeft.click",function(){n+=u;b()}).on("@arrowRight.click",function(){n-=u;b()}).on("@paste",function(a){h=!0;E("<span> </span>");var b=G(a[0]),c=a.scrollTop(),e=d("<div/>").appendTo(d("BODY")).attr("contenteditable",
"true").css({position:"fixed",left:"-999px",width:"1px",height:"1px",top:"20px",overflow:"hidden"}).focus();q.setTimeout(function(){var g="caret-"+(new Date).getTime();a.focus();J(a[0],b);E(L(H(e.html().replace(/\r\n|\n|\r/g,"<br>")),f));e.remove();E('<i id="'+g+'"></i>');a.scrollTop(c);var g=d("#"+g),p=g.offset().top-a.offset().top,l=a.height();(c+p>=l||c>p)&&a.scrollTop(c+p-2*l/3);g.remove();h=!1},200)}).on("@emojibtn.click",function(a){G(g[0]);E(I(a.children().data("name"),'<img alt="{alt}" class="emojione'+
(f.sprite?'-{uni}" src="'+M+'">':'" src="{img}">')))}).on("@area.mousedown",function(b,c){!a.autoHideFilters&&!e.is(".focused")&&b.focus();c.preventDefault();return!1}).on("@change",function(a){a=a.html().replace(/<\/?(?:div|span|p)[^>]*>/ig,"");(!a.length||/^<br[^>]*>$/i.test(a))&&f.setText("",!1);c[p](f.getText())}).on("@focus",function(){w();y=P(w,500);e.addClass("focused");a.autoHideFilters&&l.slideDown(400)}).on("@blur",function(d){n=0;b();e.removeClass("focused");Q(y);a.autoHideFilters&&l.slideUp(400);
z.filter(".active").removeClass("active");v.children().hide();d=d.html();f.content!==d?(f.content=d,F(f,"change",[g]),c.blur().trigger("change")):c.blur()})}var M="data:image/gif;base64,R0lGODlhAQABAJH/AP///wAAAMDAwAAAACH5BAEAAAIALAAAAAABAAEAAAICVAEAOw==",U={template:"<editor/><filters/><tabs/>",dir:"ltr",spellcheck:!1,autocomplete:"off",autocorrect:"off",autocapitalize:"off",placeholder:null,container:null,hideSource:!0,autoHideFilters:!1,useSprite:!0,filters:{people:{icon:"yum",emoji:"grinning,grin,joy,smiley,smile,sweat_smile,laughing,innocent,smiling_imp,imp,wink,blush,relaxed,yum,relieved,heart_eyes,sunglasses,smirk,neutral_face,expressionless,unamused,sweat,pensive,confused,confounded,kissing,kissing_heart,kissing_smiling_eyes,kissing_closed_eyes,stuck_out_tongue,stuck_out_tongue_winking_eye,stuck_out_tongue_closed_eyes,disappointed,worried,angry,rage,cry,persevere,triumph,disappointed_relieved,frowning,anguished,fearful,weary,sleepy,tired_face,grimacing,sob,open_mouth,hushed,cold_sweat,scream,astonished,flushed,sleeping,dizzy_face,no_mouth,mask,slight_frown,slight_smile,smile_cat,joy_cat,smiley_cat,heart_eyes_cat,smirk_cat,kissing_cat,pouting_cat,crying_cat_face,scream_cat,footprints,bust_in_silhouette,busts_in_silhouette,levitate,spy,baby,boy,girl,man,woman,family,family_mwg,family_mwgb,family_mwbb,family_mwgg,family_wwb,family_wwg,family_wwgb,family_wwbb,family_wwgg,family_mmb,family_mmg,family_mmgb,family_mmbb,family_mmgg,couple,two_men_holding_hands,two_women_holding_hands,dancers,bride_with_veil,person_with_blond_hair,man_with_gua_pi_mao,man_with_turban,older_man,older_woman,cop,construction_worker,princess,guardsman,angel,santa,ghost,japanese_ogre,japanese_goblin,poop,skull,alien,space_invader,bow,information_desk_person,no_good,ok_woman,raising_hand,person_with_pouting_face,person_frowning,massage,haircut,couple_with_heart,couple_ww,couple_mm,couplekiss,kiss_ww,kiss_mm,raised_hands,clap,ear,eye,eyes,nose,lips,kiss,tongue,nail_care,wave,thumbsup,thumbsdown,point_up,point_up_2,point_down,point_left,point_right,ok_hand,v,punch,fist,raised_hand,muscle,open_hands,writing_hand,hand_splayed,middle_finger,vulcan,pray"},
...
K=[].slice,k=q.emojione||!1,G,J,u={},m={},P=q.setInterval,Q=q.clearInterval,y=[],O;k||d.getScript("https://cdn.jsdelivr.net/emojione/1.5.0/lib/js/emojione.min.js",function(){k=q.emojione;k.imagePathPNG="https://cdnjs.cloudflare.com/ajax/libs/emojione/1.5.0/assets/png/";h.createStyleSheet?h.createStyleSheet("https://cdnjs.cloudflare.com/ajax/libs/emojione/1.5.0/assets/sprites/emojione.sprites.css"):d("<link/>",{rel:"stylesheet",href:"https://cdnjs.cloudflare.com/ajax/libs/emojione/1.5.0/assets/sprites/emojione.sprites.css"}).appendTo("head");
d.each(y,function(c,a){a()})});w(function(){d.each(k.emojioneList,function(c,a){u[c.replace("-","_")]=a});O=RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|("+k.unicodeRegexp+")","gi")});q.getSelection&&h.createRange?(G=function(c){var a=q.getSelection().getRangeAt(0),b=a.cloneRange();b.selectNodeContents(c);b.setEnd(a.startContainer,a.startOffset);c=b.toString().length;return{start:c,end:c+H(d("<div/>").append(a.extractContents()).html()).length}},
J=function(c,a){var b=0,f=h.createRange();f.setStart(c,0);f.collapse(!0);for(var d=[c],e,k=!1,m=!1;!m&&(e=d.pop());)if(3==e.nodeType){var g=b+e.length;!k&&(a.start>=b&&a.start<=g)&&(f.setStart(e,a.start-b),k=!0);k&&(a.end>=b&&a.end<=g)&&(f.setEnd(e,a.end-b),m=!0);b=g}else for(g=e.childNodes.length;g--;)d.push(e.childNodes[g]);b=q.getSelection();b.removeAllRanges();b.addRange(f)}):h.selection&&h.body.createTextRange&&(G=function(c){var a=h.selection.createRange(),b=h.body.createTextRange();b.moveToElementText(c);
b.setEndPoint("EndToStart",a);c=b.text.length;return{start:c,end:c+a.text.length}},J=function(c,a){var b=h.body.createTextRange();b.moveToElementText(c);b.collapse(!0);b.moveEnd("character",a.end);b.moveStart("character",a.start);b.select()});var t=function(c,a){var b=this;w(function(){T.apply(b,[c,a])})};t.prototype.on=function(c,a){var b=this.id;c&&d.isFunction(a)&&d.each(c.toLowerCase().split(" "),function(c,d){m[b][d]||(m[b][d]=[]);m[b][d].push(a)});return this};t.prototype.off=function(c,a){var b=
this.id,f=/^@/;c&&d.each(c.toLowerCase().split(" "),function(c,e){m[b][e]&&!f.test(e)&&(a?d.each(m[b][e],function(c,d){d===a&&(m[b][e]=m[b][e].splice(c,1))}):m[b][e]=[])});return this};t.prototype.setText=function(c){var a=this,b=arguments;w(function(){a.editor.html(L(c,a));a.content=a.editor.html();1===b.length&&F(a,"change",[a.editor])})};t.prototype.getText=function(){return H(this.editor.html())};d.fn.emojioneArea=function(c){return this.each(function(){return this.emojioneArea?this.emojioneArea:
