...
""))&&this.setText("");c[h](this.getText())}).on("@focus",function(){g.addClass("focused");b.autoHideFilters&&m.slideDown(400)}).on("@blur",function(c){g.removeClass("focused");b.autoHideFilters&&m.slideUp(400);m.find(".active").removeClass("active");e.children().hide();c=c.html();a.content!==c&&(a.content=c,w.apply(a,["change",a.content]))})}var H={template:"<editor/><filters/><tabs/>",dir:"ltr",spellcheck:!0,autocomplete:"off",autocorrect:"off",autocapitalize:"off",placeholder:null,container:null,
