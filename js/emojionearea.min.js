(function(h,s,f,k){function D(b){var a,c;if(s.getSelection){if(a=s.getSelection(),a.getRangeAt&&a.rangeCount){c=a.getRangeAt(0);c.deleteContents();var d=h.createElement("div");d.innerHTML=b;b=h.createDocumentFragment();for(var f,e;f=d.firstChild;)e=b.appendChild(f);c.insertNode(b);e&&(c=c.cloneRange(),c.setStartAfter(e),c.collapse(!0),a.removeAllRanges(),a.addRange(c))}}else h.selection&&"Control"!=h.selection.type&&h.selection.createRange().pasteHTML(b)}function E(b,a,c){var d=!0,p=1;if(a){a=a.toLowerCase();
c=c||[];do{var e=1==p?"@"+a:a;m[b.id][e]&&m[b.id][e].length&&f.each(m[b.id][e],function(a,e){return d=!1!==e.apply(b,c)})}while(d&&p--)}return d}function M(b,a){return f(a.currentTarget)}function t(b,a,c,d){function p(a,c,e){a.on(c,function(){var a=f.isFunction(d)?d.apply(b,[c].concat(x.call(arguments))):d;a&&E(b,e,[a].concat(x.call(arguments)))})}function e(a){"string"===(typeof c).toLowerCase()?p(a,c,c):f.each(c,function(b,d){p(a,f.isArray(c)?d:b,d)})}d=d||M;f.isArray(a)?f.each(a,function(a,c){e(f(c))}):
e(a)}function K(b){return N(b.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/(?:\r\n|\r|\n)/g,"\n").replace(/(\n+)/g,"<div>$1</div>").replace(/\n/g,"<br/>").replace(/<br\/><\/div>/g,"</div>")).replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/  /g,"&nbsp;&nbsp;")}function G(b){return b.replace(/<img[^>]*alt="([^"]+)"[^>]*>/ig,"$1").replace(/\n|\r/g,"").replace(/<br[^>]*>/ig,"\n").replace(/(?:<(?:div|p|ol|ul|li|pre|code|object)[^>]*>)+/ig,"<div>").replace(/(?:<\/(?:div|p|ol|ul|li|pre|code|object)>)+/ig,
"</div>").replace(/\n<div><\/div>/ig,"\n").replace(/<div><\/div>\n/ig,"\n").replace(/(?:<div>)+<\/div>/ig,"\n").replace(/([^\n])<\/div><div>/ig,"$1\n").replace(/(?:<\/div>)+/ig,"</div>").replace(/([^\n])<\/div>([^\n])/ig,"$1\n$2").replace(/<\/div>/ig,"").replace(/([^\n])<div>/ig,"$1\n").replace(/\n<div>/ig,"\n").replace(/<div>\n/ig,"\n\n").replace(/<(?:[^>]+)?>/g,"").replace(/&nbsp;/g," ").replace(/\x20\x20/g,"&nbsp; ").replace(/\x20\x20/g," &nbsp;")}function N(b){return b.replace(RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|("+
k.unicodeRegexp+")","gi"),function(a){if("undefined"===typeof a||""===a||!(a in k.jsecapeMap))return a;a=k.jsecapeMap[a];return'<img class="emojione" alt="'+k.convert(a)+'" src="'+k.imagePathPNG+a+".png"+k.cacheBustParam+'"/>'})}function H(b,a){return b.replace(/:?[\w_]+:?,?/g,function(c){c=":"+c.replace(/,$/,"").replace(/:$/,"").replace(/^:/,"")+":";if(c in u){var b=u[c][u[c].length-1].toUpperCase(),f=k.convert(b);return a.replace("{shortname}",c).replace("{imagePng}",k.imagePathPNG+b+".png"+k.cacheBustParam).replace("{unicode}",
b).replace("{alt}",f)}return c})}function O(b,a){function c(){w||(f.each(y,function(a,c){w+=f(c).outerWidth(!0)}),u=y.eq(0).outerWidth(!0));w>z?(A.addClass("active"),B.addClass("active"),n+w<=z?(n=z-w,A.removeClass("active")):0<=n&&(n=0,B.removeClass("active")),r.css("left",n)):(0!==n&&(n=0,r.css("left",n)),A.removeClass("active"),B.removeClass("active"))}a=f.extend({},P,a);var d=this,p=b.is("TEXTAREA")||b.is("INPUT")?"val":"text",e=a.template,h=!1,k=a.container?f(a.container):!1,g,l,v,r,y,B,A,z,
n=0,w=0,u,x=function(){var a=l.width();a!==z&&(z=a,E(d,"resize",[g]))},L;d.placeholder=a.placeholder||b.data("placeholder")||b.attr("placeholder")||"";m[d.id]={};for(var C=["editor","filters","tabs"],q=0;3>q;q++)e=e.replace(RegExp("<"+C[q]+"/?>","i"),'<div class="emojionearea-'+C[q]+'"></div>');e=f("<div>"+e+"</div>").addClass("emojionearea").attr("role","application");this.editor=e.find(".emojionearea-editor").attr("contenteditable","true").attr("placeholder",d.placeholder).attr("tabindex",0);g=
d.editor;C=["dir","spellcheck","autocomplete","autocorrect","autocapitalize"];for(q=0;5>q;q++)g.attr(C[q],a[C[q]]);l=e.find(".emojionearea-filters");a.autoHideFilters&&l.hide();v=e.find(".emojionearea-tabs");f.each(a.filters,function(a,c){f("<span/>").wrapInner(H(c.icon,'<span class="emojione-{unicode}">{alt}</span>')).addClass("emojionearea-filter").attr("data-filter",a).attr("role","button").appendTo(l);f("<div/>").wrapInner(H(c.emoji,'<span class="emojibtn"><span class="emojione-{unicode}" data-shortname="{shortname}">{alt}</span></span>')).addClass("emojionearea-tab").addClass("emojionearea-tab-"+
a).hide().appendTo(v)});l.wrapInner('<div class="emojionearea-filters-scroll"/>');B=f('<i class="emojionearea-filter-arrow-left"/>').appendTo(l);A=f('<i class="emojionearea-filter-arrow-right"/>').appendTo(l);y=l.find(".emojionearea-filter");r=l.children(".emojionearea-filters-scroll");k?k.wrapInner(e):e.insertAfter(b);a.hideSource&&b.hide();d.setText(b[p]());t(d,[l,v],{mousedown:"area.mousedown"},g);t(d,g,"paste",g);t(d,g,["focus","blur"],function(){return h?!1:g});t(d,[g,l,v],["mousedown","mouseup",
"click","keyup","keydown"],g);t(d,l.find(".emojionearea-filter"),{click:"filter.click"});t(d,v.find(".emojibtn"),{click:"emojibtn.click"});t(d,B,{click:"arrowLeft.click"});t(d,A,{click:"arrowRight.click"});d.on("@filter.click",function(a){a.is(".active")?(a.removeClass("active"),v.children().hide()):(y.filter(".active").removeClass("active"),a.addClass("active"),v.children().hide().filter(".emojionearea-tab-"+a.data("filter")).show())}).on("@resize",function(){c()}).on("@arrowLeft.click",function(){n+=
u;c()}).on("@arrowRight.click",function(){n-=u;c()}).on("@paste",function(a){h=!0;D("<span>&nbsp;</span>");var c=F(a[0]),b=I.scrollTop(),d=a.scrollTop(),e=f("<div/>").appendTo(f("BODY")).attr("contenteditable","true").css({position:"fixed",left:"-999px",width:"1px",height:"1px",top:10}).focus();I.scrollTop(b);s.setTimeout(function(){var g="caret-"+(new Date).getTime();a.focus();J(a[0],c);D(K(G(e.html().replace(/\r\n|\n|\r/g,"<br>"))));e.remove();D('<span id="'+g+'"></span>');I.scrollTop(b);a.scrollTop(d);
var g=f("#"+g),p=g.offset().top-a.offset().top,l=a.height();(d+p>=l||d>p)&&a.scrollTop(d+p-2*l/3);g.remove();h=!1},200)}).on("@emojibtn.click",function(a){F(g[0]);D(H(a.children("span").data("shortname"),'<img class="emojione" alt="{alt}" src="{imagePng}"/>'))}).on("@area.mousedown",function(c,b){!a.autoHideFilters&&!e.is(".focused")&&c.focus();b.preventDefault();return!1}).on("@change",function(a){a=a.html();/^<br[^>]*>$/i.test(a.replace(/<\/?(?:div|span|p)[^>]*>/ig,""))&&d.setText("",!1);b[p](d.getText())}).on("@focus",
function(){x();L=s.setInterval(x,500);e.addClass("focused");a.autoHideFilters&&l.slideDown(400)}).on("@blur",function(b){n=0;c();e.removeClass("focused");s.clearInterval(L);a.autoHideFilters&&l.slideUp(400);y.filter(".active").removeClass("active");v.children().hide();b=b.html();d.content!==b&&(d.content=b,E(d,"change",[g]))})}var P={template:"<editor/><filters/><tabs/>",dir:"ltr",spellcheck:!0,autocomplete:"off",autocorrect:"off",autocapitalize:"off",placeholder:null,container:null,hideSource:!0,
autoHideFilters:!1,filters:{people:{icon:"yum",emoji:"grinning,grin,joy,smiley,smile,sweat_smile,laughing,innocent,smiling_imp,imp,wink,blush,relaxed,yum,relieved,heart_eyes,sunglasses,smirk,neutral_face,expressionless,unamused,sweat,pensive,confused,confounded,kissing,kissing_heart,kissing_smiling_eyes,kissing_closed_eyes,stuck_out_tongue,stuck_out_tongue_winking_eye,stuck_out_tongue_closed_eyes,disappointed,worried,angry,rage,cry,persevere,triumph,disappointed_relieved,frowning,anguished,fearful,weary,sleepy,tired_face,grimacing,sob,open_mouth,hushed,cold_sweat,scream,astonished,flushed,sleeping,dizzy_face,no_mouth,mask,slight_frown,slight_smile,smile_cat,joy_cat,smiley_cat,heart_eyes_cat,smirk_cat,kissing_cat,pouting_cat,crying_cat_face,scream_cat,footprints,bust_in_silhouette,busts_in_silhouette,levitate,spy,baby,boy,girl,man,woman,family,family_mwg,family_mwgb,family_mwbb,family_mwgg,family_wwb,family_wwg,family_wwgb,family_wwbb,family_wwgg,family_mmb,family_mmg,family_mmgb,family_mmbb,family_mmgg,couple,two_men_holding_hands,two_women_holding_hands,dancers,bride_with_veil,person_with_blond_hair,man_with_gua_pi_mao,man_with_turban,older_man,older_woman,cop,construction_worker,princess,guardsman,angel,santa,ghost,japanese_ogre,japanese_goblin,poop,skull,alien,space_invader,bow,information_desk_person,no_good,ok_woman,raising_hand,person_with_pouting_face,person_frowning,massage,haircut,couple_with_heart,couple_ww,couple_mm,couplekiss,kiss_ww,kiss_mm,raised_hands,clap,ear,eye,eyes,nose,lips,kiss,tongue,nail_care,wave,thumbsup,thumbsdown,point_up,point_up_2,point_down,point_left,point_right,ok_hand,v,punch,fist,raised_hand,muscle,open_hands,writing_hand,hand_splayed,middle_finger,vulcan,pray"},
...
x=[].slice,F,J,u={},I=f(h),m={};f.each(k.emojioneList,function(b,a){u[b.replace("-","_")]=a});s.getSelection&&h.createRange?(F=function(b){var a=s.getSelection().getRangeAt(0),c=a.cloneRange();c.selectNodeContents(b);c.setEnd(a.startContainer,a.startOffset);b=c.toString().length;return{start:b,end:b+G(f("<div/>").append(a.extractContents()).html()).length}},J=function(b,a){var c=0,d=h.createRange();d.setStart(b,0);d.collapse(!0);for(var f=[b],e,k=!1,m=!1;!m&&(e=f.pop());)if(3==e.nodeType){var g=c+
e.length;!k&&(a.start>=c&&a.start<=g)&&(d.setStart(e,a.start-c),k=!0);k&&(a.end>=c&&a.end<=g)&&(d.setEnd(e,a.end-c),m=!0);c=g}else for(g=e.childNodes.length;g--;)f.push(e.childNodes[g]);c=s.getSelection();c.removeAllRanges();c.addRange(d)}):h.selection&&h.body.createTextRange&&(F=function(b){var a=h.selection.createRange(),c=h.body.createTextRange();c.moveToElementText(b);c.setEndPoint("EndToStart",a);b=c.text.length;return{start:b,end:b+a.text.length}},J=function(b,a){var c=h.body.createTextRange();
c.moveToElementText(b);c.collapse(!0);c.moveEnd("character",a.end);c.moveStart("character",a.start);c.select()});var r=function(b,a){this.id=(new Date).getTime();O.apply(this,[b,a])};r.prototype.on=function(b,a){var c=this.id;b&&f.isFunction(a)&&f.each(b.toLowerCase().split(" "),function(b,f){m[c][f]||(m[c][f]=[]);m[c][f].push(a)});return this};r.prototype.off=function(b,a){var c=this.id,d=/^@/;b&&f.each(b.toLowerCase().split(" "),function(b,e){m[c][e]&&!d.test(e)&&(a?f.each(m[c][e],function(b,d){d===
a&&(m[c][e]=m[c][e].splice(b,1))}):m[c][e]=[])});return this};r.prototype.setText=function(b){this.editor.html('<div class="placeholder-fix">'+K(b)+"</div>");this.placeholder&&this.editor.children(".placeholder-fix:first").attr("placeholder",this.placeholder);this.content=this.editor.html();1===arguments.length&&E(this,"change",[this.editor])};r.prototype.getText=function(){return G(this.editor.html())};f.fn.emojioneArea=function(b){return this.each(function(){return this.emojioneArea?this.emojioneArea:
this.emojioneArea=new r(f(this),b)})}})(document,window,jQuery,emojione);
