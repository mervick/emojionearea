(function(k,q,f,r){function D(c){var a,b;if(q.getSelection){if(a=q.getSelection(),a.getRangeAt&&a.rangeCount){b=a.getRangeAt(0);b.deleteContents();var d=k.createElement("div");d.innerHTML=c;c=k.createDocumentFragment();for(var f,e;f=d.firstChild;)e=c.appendChild(f);b.insertNode(c);e&&(b=b.cloneRange(),b.setStartAfter(e),b.collapse(!0),a.removeAllRanges(),a.addRange(b))}}else k.selection&&"Control"!=k.selection.type&&k.selection.createRange().pasteHTML(c)}function E(c,a,b){var d=!0,p=1;if(a){a=a.toLowerCase();
b=b||[];do{var e=1==p?"@"+a:a;l[c.id][e]&&l[c.id][e].length&&f.each(l[c.id][e],function(a,e){return d=!1!==e.apply(c,b)})}while(d&&p--)}return d}function M(c,a){return f(a.currentTarget)}function s(c,a,b,d){function p(a,b,e){a.on(b,function(){var a=f.isFunction(d)?d.apply(c,[b].concat(x.call(arguments))):d;a&&E(c,e,[a].concat(x.call(arguments)))})}function e(a){"string"===(typeof b).toLowerCase()?p(a,b,b):f.each(b,function(c,d){p(a,f.isArray(b)?d:c,d)})}d=d||M;f.isArray(a)?f.each(a,function(a,b){e(f(b))}):
e(a)}function K(c,a){return N(c.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/(?:\r\n|\r|\n)/g,"\n").replace(/(\n+)/g,"<div>$1</div>").replace(/\n/g,"<br/>").replace(/<br\/><\/div>/g,"</div>"),'<img alt="{alt}" class="emojione'+(a.sprite?'-{uni}" src="'+L+'">':'" src="{img}">')).replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/  /g,"&nbsp;&nbsp;")}function G(c){return c.replace(/<img[^>]*alt="([^"]+)"[^>]*>/ig,"$1").replace(/\n|\r/g,"").replace(/<br[^>]*>/ig,"\n").replace(/(?:<(?:div|p|ol|ul|li|pre|code|object)[^>]*>)+/ig,
"<div>").replace(/(?:<\/(?:div|p|ol|ul|li|pre|code|object)>)+/ig,"</div>").replace(/\n<div><\/div>/ig,"\n").replace(/<div><\/div>\n/ig,"\n").replace(/(?:<div>)+<\/div>/ig,"\n").replace(/([^\n])<\/div><div>/ig,"$1\n").replace(/(?:<\/div>)+/ig,"</div>").replace(/([^\n])<\/div>([^\n])/ig,"$1\n$2").replace(/<\/div>/ig,"").replace(/([^\n])<div>/ig,"$1\n").replace(/\n<div>/ig,"\n").replace(/<div>\n/ig,"\n\n").replace(/<(?:[^>]+)?>/g,"").replace(/&nbsp;/g," ").replace(/\x20\x20/g,"&nbsp; ").replace(/\x20\x20/g,
" &nbsp;")}function y(c,a,b){return c.replace("{name}",b||"").replace("{img}",r.imagePathPNG+a+".png").replace("{uni}",a).replace("{alt}",r.convert(a))}function N(c,a){return c.replace(O,function(b){return"undefined"!==typeof b&&b in r.jsecapeMap?y(a,r.jsecapeMap[b]):b})}function H(c,a){return c.replace(/:?[\w_]+:?/g,function(b){b=":"+b.replace(/:$/,"").replace(/^:/,"")+":";return b in u?y(a,u[b][u[b].length-1].toUpperCase(),b):b})}function P(c,a){function b(){w||(f.each(m,function(a,b){w+=f(b).outerWidth(!0)}),
u=m.eq(0).outerWidth(!0));w>z?(A.addClass("active"),B.addClass("active"),n+w<=z?(n=z-w,A.removeClass("active")):0<=n&&(n=0,B.removeClass("active")),r.css("left",n)):(0!==n&&(n=0,r.css("left",n)),A.removeClass("active"),B.removeClass("active"))}a=f.extend({},Q,a);var d=this,p=c.is("TEXTAREA")||c.is("INPUT")?"val":"text",e=a.template,k=!1,J=a.container?f(a.container):!1,g,h,v,r,m,B,A,z,n=0,w=0,u,x=function(){var a=h.width();a!==z&&(z=a,E(d,"resize",[g]))},y;d.id=(new Date).getTime();d.placeholder=a.placeholder||
c.data("placeholder")||c.attr("placeholder")||"";d.sprite=a.useSprite;l[d.id]={};for(var C=["editor","filters","tabs"],t=0;3>t;t++)e=e.replace(RegExp("<"+C[t]+"/?>","i"),'<div class="emojionearea-'+C[t]+'"></div>');e=f("<div>"+e+"</div>").addClass("emojionearea").attr("role","application");this.editor=e.find(".emojionearea-editor").attr("contenteditable","true").attr("placeholder",d.placeholder).attr("tabindex",0);g=d.editor;C=["dir","spellcheck","autocomplete","autocorrect","autocapitalize"];for(t=
0;5>t;t++)g.attr(C[t],a[C[t]]);h=e.find(".emojionearea-filters");a.autoHideFilters&&h.hide();v=e.find(".emojionearea-tabs");f.each(a.filters,function(a,b){f("<i/>").wrapInner(H(b.icon,d.sprite?'<i class="emojione-{uni}"/>':'<img class="emojione" src="{img}"/>')).addClass("emojionearea-filter").data("filter",a).appendTo(h);f("<div/>").data("items",H(b.emoji,'<i class="emojibtn" role="button">'+(d.sprite?'<i class="emojione-{uni}"':'<img class="emojione" src="{img}"')+' data-name="{name}"/></i>')).addClass("emojionearea-tab").addClass("emojionearea-tab-"+
a).hide().appendTo(v)});h.wrapInner('<div class="emojionearea-filters-scroll"/>');B=f('<i class="emojionearea-filter-arrow-left"/>').attr("role","button").appendTo(h);A=f('<i class="emojionearea-filter-arrow-right"/>').attr("role","button").appendTo(h);m=h.find(".emojionearea-filter");r=h.children(".emojionearea-filters-scroll");J?J.wrapInner(e):e.insertAfter(c);a.hideSource&&c.hide();d.setText(c[p]());s(d,[h,v],{mousedown:"area.mousedown"},g);s(d,g,"paste",g);s(d,g,["focus","blur"],function(){return k?
!1:g});s(d,[g,h,v],["mousedown","mouseup","click","keyup","keydown"],g);s(d,h.find(".emojionearea-filter"),{click:"filter.click"});s(d,B,{click:"arrowLeft.click"});s(d,A,{click:"arrowRight.click"});d.on("@filter.click",function(a){if(a.is(".active"))a.removeClass("active"),v.children().hide();else{m.filter(".active").removeClass("active");a.addClass("active");var b,c,e=v.children().hide().filter(".emojionearea-tab-"+a.data("filter")).show(),f=e.data("items"),g={click:"emojibtn.click"};f&&(e.data("items",
!1),f=f.split(","),d.sprite?(e.html(f.join("")),s(d,e.find(".emojibtn"),g)):c=q.setInterval(function(){for(b=0;20>b&&f.length;b++)e.append(f.shift()),s(d,e.find(".emojibtn").not(".handled").addClass("handled"),g);f.length||q.clearInterval(c)},5))}}).on("@resize",function(){b()}).on("@arrowLeft.click",function(){n+=u;b()}).on("@arrowRight.click",function(){n-=u;b()}).on("@paste",function(a){k=!0;D("<span> </span>");var b=F(a[0]),c=a.scrollTop(),e=f("<div/>").appendTo(f("BODY")).attr("contenteditable",
"true").css({position:"fixed",left:"-999px",width:"1px",height:"1px",top:"20px",overflow:"hidden"}).focus();q.setTimeout(function(){var g="caret-"+(new Date).getTime();a.focus();I(a[0],b);D(K(G(e.html().replace(/\r\n|\n|\r/g,"<br>")),d));e.remove();D('<i id="'+g+'"></i>');a.scrollTop(c);var g=f("#"+g),p=g.offset().top-a.offset().top,h=a.height();(c+p>=h||c>p)&&a.scrollTop(c+p-2*h/3);g.remove();k=!1},200)}).on("@emojibtn.click",function(a){F(g[0]);D(H(a.children().data("name"),'<img alt="{alt}" class="emojione'+
(d.sprite?'-{uni}" src="'+L+'">':'" src="{img}">')))}).on("@area.mousedown",function(b,c){!a.autoHideFilters&&!e.is(".focused")&&b.focus();c.preventDefault();return!1}).on("@change",function(a){a=a.html().replace(/<\/?(?:div|span|p)[^>]*>/ig,"");(!a.length||/^<br[^>]*>$/i.test(a))&&d.setText("",!1);c[p](d.getText())}).on("@focus",function(){x();y=q.setInterval(x,500);e.addClass("focused");a.autoHideFilters&&h.slideDown(400)}).on("@blur",function(c){n=0;b();e.removeClass("focused");q.clearInterval(y);
a.autoHideFilters&&h.slideUp(400);m.filter(".active").removeClass("active");v.children().hide();c=c.html();d.content!==c&&(d.content=c,E(d,"change",[g]))})}var L="data:image/gif;base64,R0lGODlhAQABAJH/AP///wAAAMDAwAAAACH5BAEAAAIALAAAAAABAAEAAAICVAEAOw==",Q={template:"<editor/><filters/><tabs/>",dir:"ltr",spellcheck:!1,autocomplete:"off",autocorrect:"off",autocapitalize:"off",placeholder:null,container:null,hideSource:!0,autoHideFilters:!1,useSprite:!0,filters:{people:{icon:"yum",emoji:"grinning,grin,joy,smiley,smile,sweat_smile,laughing,innocent,smiling_imp,imp,wink,blush,relaxed,yum,relieved,heart_eyes,sunglasses,smirk,neutral_face,expressionless,unamused,sweat,pensive,confused,confounded,kissing,kissing_heart,kissing_smiling_eyes,kissing_closed_eyes,stuck_out_tongue,stuck_out_tongue_winking_eye,stuck_out_tongue_closed_eyes,disappointed,worried,angry,rage,cry,persevere,triumph,disappointed_relieved,frowning,anguished,fearful,weary,sleepy,tired_face,grimacing,sob,open_mouth,hushed,cold_sweat,scream,astonished,flushed,sleeping,dizzy_face,no_mouth,mask,slight_frown,slight_smile,smile_cat,joy_cat,smiley_cat,heart_eyes_cat,smirk_cat,kissing_cat,pouting_cat,crying_cat_face,scream_cat,footprints,bust_in_silhouette,busts_in_silhouette,levitate,spy,baby,boy,girl,man,woman,family,family_mwg,family_mwgb,family_mwbb,family_mwgg,family_wwb,family_wwg,family_wwgb,family_wwbb,family_wwgg,family_mmb,family_mmg,family_mmgb,family_mmbb,family_mmgg,couple,two_men_holding_hands,two_women_holding_hands,dancers,bride_with_veil,person_with_blond_hair,man_with_gua_pi_mao,man_with_turban,older_man,older_woman,cop,construction_worker,princess,guardsman,angel,santa,ghost,japanese_ogre,japanese_goblin,poop,skull,alien,space_invader,bow,information_desk_person,no_good,ok_woman,raising_hand,person_with_pouting_face,person_frowning,massage,haircut,couple_with_heart,couple_ww,couple_mm,couplekiss,kiss_ww,kiss_mm,raised_hands,clap,ear,eye,eyes,nose,lips,kiss,tongue,nail_care,wave,thumbsup,thumbsdown,point_up,point_up_2,point_down,point_left,point_right,ok_hand,v,punch,fist,raised_hand,muscle,open_hands,writing_hand,hand_splayed,middle_finger,vulcan,pray"},
...
x=[].slice,F,I,u={},l={};f.each(r.emojioneList,function(c,a){u[c.replace("-","_")]=a});q.getSelection&&k.createRange?(F=function(c){var a=q.getSelection().getRangeAt(0),b=a.cloneRange();b.selectNodeContents(c);b.setEnd(a.startContainer,a.startOffset);c=b.toString().length;return{start:c,end:c+G(f("<div/>").append(a.extractContents()).html()).length}},I=function(c,a){var b=0,d=k.createRange();d.setStart(c,0);d.collapse(!0);for(var f=[c],e,l=!1,m=!1;!m&&(e=f.pop());)if(3==e.nodeType){var g=b+e.length;
!l&&(a.start>=b&&a.start<=g)&&(d.setStart(e,a.start-b),l=!0);l&&(a.end>=b&&a.end<=g)&&(d.setEnd(e,a.end-b),m=!0);b=g}else for(g=e.childNodes.length;g--;)f.push(e.childNodes[g]);b=q.getSelection();b.removeAllRanges();b.addRange(d)}):k.selection&&k.body.createTextRange&&(F=function(c){var a=k.selection.createRange(),b=k.body.createTextRange();b.moveToElementText(c);b.setEndPoint("EndToStart",a);c=b.text.length;return{start:c,end:c+a.text.length}},I=function(c,a){var b=k.body.createTextRange();b.moveToElementText(c);
b.collapse(!0);b.moveEnd("character",a.end);b.moveStart("character",a.start);b.select()});var m=function(c,a){P.apply(this,[c,a])};m.prototype.on=function(c,a){var b=this.id;c&&f.isFunction(a)&&f.each(c.toLowerCase().split(" "),function(c,f){l[b][f]||(l[b][f]=[]);l[b][f].push(a)});return this};m.prototype.off=function(c,a){var b=this.id,d=/^@/;c&&f.each(c.toLowerCase().split(" "),function(c,e){l[b][e]&&!d.test(e)&&(a?f.each(l[b][e],function(c,d){d===a&&(l[b][e]=l[b][e].splice(c,1))}):l[b][e]=[])});
return this};m.prototype.setText=function(c){this.editor.html(K(c,this));this.content=this.editor.html();1===arguments.length&&E(this,"change",[this.editor])};m.prototype.getText=function(){return G(this.editor.html())};var O=RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|("+r.unicodeRegexp+")","gi");f.fn.emojioneArea=function(c){return this.each(function(){return this.emojioneArea?this.emojioneArea:this.emojioneArea=new m(f(this),c)})}})(document,
window,jQuery,emojione);
