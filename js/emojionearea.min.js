(function(g,p,c,f){function r(a){var b,d;if(p.getSelection){if(b=p.getSelection(),b.getRangeAt&&b.rangeCount){d=b.getRangeAt(0);d.deleteContents();var c=g.createElement("div");c.innerHTML=a;a=g.createDocumentFragment();for(var e,h;e=c.firstChild;)h=a.appendChild(e);d.insertNode(a);h&&(d=d.cloneRange(),d.setStartAfter(h),d.collapse(!0),b.removeAllRanges(),b.addRange(d))}}else g.selection&&"Control"!=g.selection.type&&g.selection.createRange().pasteHTML(a)}function u(a){var b=!0,d;a&&(d=v.call(arguments,
1),c.each(a.toLowerCase().split(" "),c.proxy(function(a,e){for(var h=0;1>=h;h++){var n=0==h?"@"+e:e;this.events[n]&&this.events[n].length&&c.each(this.events[n],c.proxy(function(a,c){return b=!1!==c.apply(this,d)},this));if(!b)break}return b},this)));return b}function k(a,b,d){function m(b,a,e){b.on(a,c.proxy(function(){var b=c.isFunction(d)?d.apply(this,[a].concat(v.call(arguments))):d;b&&u.apply(this,[e].concat([b]).concat(v.call(arguments)))},this))}function e(a){"string"==(typeof b).toLowerCase()?
m.apply(this,[a,b,b]):c.each(b,c.proxy(function(d,e){m.apply(this,[a,c.isArray(b)?e:d,e])},this))}d=d||function(b,a){return c(a.currentTarget)};c.isArray(a)?c.each(a,c.proxy(function(b,a){e.apply(this,[c(a)])},this)):e.apply(this,[a])}function z(a){return A(a.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/(?:\r\n|\r|\n)/g,"\n").replace(/(\n+)/g,"<div>$1</div>").replace(/\n/g,"<br/>").replace(/<br\/><\/div>/g,"</div>")).replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/  /g,"&nbsp;&nbsp;")}function w(a){return a.replace(/<img[^>]*alt="([^"]+)"[^>]*>/ig,
...
"\n\n").replace(/<(?:[^>]+)?>/g,"").replace("&nbsp;"," ")}function A(a){return a.replace(RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|("+f.unicodeRegexp+")","gi"),function(b){if("undefined"===typeof b||""===b||!(b in f.jsecapeMap))return b;b=f.jsecapeMap[b];return'<img class="emojione" alt="'+f.convert(b)+'" src="'+f.imagePathPNG+b+".png"+f.cacheBustParam+'"/>'})}function x(a,b){return a.replace(/:?[\w_]+:?,?/g,function(a){a=":"+a.replace(/,$/,
"").replace(/:$/,"").replace(/^:/,"")+":";if(a in s){var c=s[a][s[a].length-1].toUpperCase(),e=f.convert(c);return b.replace("{shortname}",a).replace("{imagePng}",f.imagePathPNG+c+".png"+f.cacheBustParam).replace("{unicode}",c).replace("{alt}",e)}return a})}function B(a){this.app=a.template;c.each(["editor","filters","tabs"],c.proxy(function(b,d){this.app=this.app.replace(RegExp("<"+d+"/?>","i"),'<div class="'+a[d+"ClassName"]+'"></div>')},this));this.app=c("<div>"+this.app+"</div>").addClass(a.className).attr("role",
...
a.tabsClassName);c.each(a.filters,c.proxy(function(b,d){c("<span/>").wrapInner(x(d.icon,'<span class="emojione-{unicode}">{alt}</span>')).addClass(a.filterClassName).attr("data-filter",b).attr("role","button").appendTo(this.filters);c("<div/>").wrapInner(x(d.emoji,'<span class="emojibtn"><span class="emojione-{unicode}" data-shortname="{shortname}">{alt}</span></span>')).addClass(a.tabClassName).addClass(a.tabClassName+"-"+b).hide().appendTo(this.tabs)},this));this.app.insertAfter(this.element);this.element.hide();
this.setText(this.element[this.elementValFunc]())}function C(a){a=c.extend({},D,a);B.apply(this,[a]);k.apply(this,[this.filters,{mousedown:"filters.mousedown"},this.editor]);k.apply(this,[this.tabs,{mousedown:"tabs.mousedown"},this.editor]);k.apply(this,[this.editor,"paste",this.editor]);k.apply(this,[this.editor,{focus:"editor.focus",blur:"editor.blur"},this.editor]);k.apply(this,[this.editor,["focus","blur"],function(){return this.stayFocused?!1:this.editor}]);k.apply(this,[[this.editor,this.filters,
this.tabs],["mousedown","mouseup","click","keyup","keydown"],this.editor]);k.apply(this,[this.filters.find("."+a.filterClassName),{click:"filter.click"}]);k.apply(this,[this.tabs.find(".emojibtn"),{click:"emojibtn.click"}]);this.on("@filter.click",function(b){b.is(".active")?(b.removeClass("active"),this.tabs.children("."+a.tabClassName).hide()):(b.parent().find("."+a.filterClassName+".active").removeClass("active"),b.addClass("active"),this.tabs.children("."+a.tabClassName).hide().filter("."+a.tabClassName+
"-"+b.data("filter")).show())}).on("@paste",function(a,d){var m="emojionearea-paster-"+(new Date).getTime(),e=c(g);r('<span id="'+m+'">&nbsp;</span>');var h=t(a[0]),n=c(g).scrollTop(),f=a.scrollTop(),l=c("<div />").appendTo(c("BODY"));this.stayFocused=!0;l.attr("contenteditable","true").attr("tabindex","0").css({position:"fixed",left:"-9999px",width:"1px",height:"1px",top:10}).focus();e.scrollTop(n);a.removeAttr("contenteditable");setTimeout(c.proxy(function(){a.attr("contenteditable","true").focus();
y(a[0],h);r(z(w(l.html().replace(/\r\n|\n|\r/g,"<br>"))));r('<span id="'+m+'-caret"></span>');e.scrollTop(n);a.scrollTop(f);var d=c("#"+m+"-caret"),g=d.offset().top-a.offset().top,k=a.height();(f+g>=k||f>g)&&a.scrollTop(f+g-2*k/3);d.remove();l.remove();this.stayFocused=!1},this),200)}).on("@emojibtn.click",function(a){t(this.editor[0]);r(x(a.children("span").data("shortname"),'<img class="emojione" alt="{alt}" src="{imagePng}"/>'))}).on("@filters.mousedown @tabs.mousedown",function(b,d){!a.autoHideFilters&&
!this.app.is(".focused")&&b.focus();d.preventDefault();return!1}).on("@change",function(){var a=this.editor.html();/^<br[^>]*>$/.test(a.replace(/<\/?div[^>]*>/g,""))&&this.setText("");this.element[this.elementValFunc](this.getText())}).on("@focus",function(){this.app.addClass("focused");a.autoHideFilters&&this.filters.slideDown(400)}).on("@blur",function(b){this.app.removeClass("focused");a.autoHideFilters&&this.filters.slideUp(400);this.filters.find("."+a.filterClassName+".active").removeClass("active");
this.tabs.children("."+a.tabClassName).hide();b=b.html();this.content!==b&&(this.content=b,u.apply(this,["change",this.content]))})}var D={template:"<editor/><filters/><tabs/>",className:"emojionearea",editorClassName:"emojionearea-editor",filtersClassName:"emojionearea-filters",filterClassName:"emojionearea-filter",tabsClassName:"emojionearea-tabs",tabClassName:"emojionearea-tab",dir:"ltr",spellcheck:!0,autocomplete:"off",autocorrect:"off",autocapitalize:"off",placeholder:null,autoHideFilters:!1,
filters:{people:{icon:"yum",emoji:"grinning,grin,joy,smiley,smile,sweat_smile,laughing,innocent,smiling_imp,imp,wink,blush,relaxed,yum,relieved,heart_eyes,sunglasses,smirk,neutral_face,expressionless,unamused,sweat,pensive,confused,confounded,kissing,kissing_heart,kissing_smiling_eyes,kissing_closed_eyes,stuck_out_tongue,stuck_out_tongue_winking_eye,stuck_out_tongue_closed_eyes,disappointed,worried,angry,rage,cry,persevere,triumph,disappointed_relieved,frowning,anguished,fearful,weary,sleepy,tired_face,grimacing,sob,open_mouth,hushed,cold_sweat,scream,astonished,flushed,sleeping,dizzy_face,no_mouth,mask,slight_frown,slight_smile,smile_cat,joy_cat,smiley_cat,heart_eyes_cat,smirk_cat,kissing_cat,pouting_cat,crying_cat_face,scream_cat,footprints,bust_in_silhouette,busts_in_silhouette,levitate,spy,baby,boy,girl,man,woman,family,family_mwg,family_mwgb,family_mwbb,family_mwgg,family_wwb,family_wwg,family_wwgb,family_wwbb,family_wwgg,family_mmb,family_mmg,family_mmgb,family_mmbb,family_mmgg,couple,two_men_holding_hands,two_women_holding_hands,dancers,bride_with_veil,person_with_blond_hair,man_with_gua_pi_mao,man_with_turban,older_man,older_woman,cop,construction_worker,princess,guardsman,angel,santa,ghost,japanese_ogre,japanese_goblin,poop,skull,alien,space_invader,bow,information_desk_person,no_good,ok_woman,raising_hand,person_with_pouting_face,person_frowning,massage,haircut,couple_with_heart,couple_ww,couple_mm,couplekiss,kiss_ww,kiss_mm,raised_hands,clap,ear,eye,eyes,nose,lips,kiss,tongue,nail_care,wave,thumbsup,thumbsdown,point_up,point_up_2,point_down,point_left,point_right,ok_hand,v,punch,fist,raised_hand,muscle,open_hands,writing_hand,hand_splayed,middle_finger,vulcan,pray"},
...
v=[].slice,t,y,s={};c.each(f.emojioneList,function(a,b){s[a.replace("-","_")]=b});p.getSelection&&g.createRange?(t=function(a){var b=p.getSelection().getRangeAt(0),d=b.cloneRange();d.selectNodeContents(a);d.setEnd(b.startContainer,b.startOffset);a=d.toString().length;return{start:a,end:a+w(c("<div/>").append(b.extractContents()).html()).length}},y=function(a,b){var d=0,c=g.createRange();c.setStart(a,0);c.collapse(!0);for(var e=[a],h,f=!1,k=!1;!k&&(h=e.pop());)if(3==h.nodeType){var l=d+h.length;!f&&
(b.start>=d&&b.start<=l)&&(c.setStart(h,b.start-d),f=!0);f&&(b.end>=d&&b.end<=l)&&(c.setEnd(h,b.end-d),k=!0);d=l}else for(l=h.childNodes.length;l--;)e.push(h.childNodes[l]);d=p.getSelection();d.removeAllRanges();d.addRange(c)}):g.selection&&g.body.createTextRange&&(t=function(a){var b=g.selection.createRange(),d=g.body.createTextRange();d.moveToElementText(a);d.setEndPoint("EndToStart",b);a=d.text.length;return{start:a,end:a+b.text.length}},y=function(a,b){var d=g.body.createTextRange();d.moveToElementText(a);
d.collapse(!0);d.moveEnd("character",b.end);d.moveStart("character",b.start);d.select()});var q=function(a,b){this.element=c(a);this.elementValFunc=this.element.is("INPUT")?"val":"text";this.events={};C.apply(this,[b])};q.prototype.on=function(a,b){a&&c.isFunction(b)&&c.each(a.toLowerCase().split(" "),c.proxy(function(a,c){this.events[c]||(this.events[c]=[]);this.events[c].push(b)},this));return this};q.prototype.off=function(a,b){if(a){var d=/^@/;c.isFunction(b)?c.each(a.toLowerCase().split(" "),
c.proxy(function(a,e){!d.test(e)&&(this.events[e]&&this.events[e].length)&&c.each(this.events[e],c.proxy(function(a,c){c===b&&(this.events[e]=this.events[e].splice(a,1))},this))},this)):c.each(a.split(" "),c.proxy(function(a,b){d.test(b)||(this.events[b]=[])},this))}return this};q.prototype.setText=function(a){this.editor.html('<div class="placeholder-fix">'+z(a)+"</div>");this.placeholder&&this.editor.children(".placeholder-fix:first").attr("placeholder",this.placeholder);this.content=this.editor.html();
u.apply(this,["change",this.content])};q.prototype.getText=function(){return w(this.editor.html())};c.fn.emojioneArea=function(a){return this.each(function(){return this.emojioneArea?this.emojioneArea:this.emojioneArea=new q(c(this),a)})}})(document,window,jQuery,emojione);
